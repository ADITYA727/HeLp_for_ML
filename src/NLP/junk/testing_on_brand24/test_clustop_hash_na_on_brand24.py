...
def cluster_tweets_based_on_hashtag():
    ...
    joblib.dump(hashtags, 'src/NLP/junk/testing_on_brand24/data/clustop_hashtags.pkl')
    ...
    # hashtags = joblib.load('src/NLP/junk/testing_on_brand24/data/clustop_hashtags.pkl')
